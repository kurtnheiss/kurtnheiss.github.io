...
Refer to the [Dad Jokes API Overview](https://kurtnheiss.github.io/dad_jokes_files/dad_jokes_overview.html) for conceptual and usage information.
### Resource details
...
> **NOTE:** Python, JavaScript, Java, Ruby, and other popular programming languages can be used to make HTTP requests to the Dad Joke API endpoints; however, examples using these languages are out of the scope for this tutorial and not included.
